...
public class MatchesServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        totalPages = (int) Math.ceil((double) notes / NOTES_IN_PAGE);
        request.setAttribute("totalPages", totalPages);
        request.setAttribute("currentPage", currentPage);
        request.setAttribute("matchWebDto", matchesHadler.paginate(matchesWebDto, currentPage));
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse respnse) throws ServletException, IOException {
        ...
        if (request.getParameter("pName") != null) foundPlayer = request.getParameter("pName");
